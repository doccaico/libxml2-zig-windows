...
// 1
// // test examples/reader1.zig
// const test_reader1 = b.addTest(.{
//     .root_source_file = .{ .path = "examples/reader1.zig" },
//     .optimize = optimize,
// });
//
// test_reader1.addIncludePath(.{ .path = "include" });
// test_reader1.addIncludePath(.{ .path = include_dir });
// test_reader1.addIncludePath(.{ .path = override_include_dir });
// test_reader1.addIncludePath(.{ .path = win32_include_dir });
// test_reader1.linkLibrary(libxml2);
//
// const test_step = b.step("tests", "Run tests");
// test_step.dependOn(&libxml2.step);
// test_step.dependOn(&test_reader1.step);

// 2
// const exe_reader1 = b.addExecutable(.{
//     .name = "reader1",
//     .root_source_file = .{ .path = "examples/reader1.zig" },
//     .target = target,
//     .optimize = optimize,
// });
//
// exe_reader1.addIncludePath(.{ .path = "include" });
// exe_reader1.addIncludePath(.{ .path = include_dir });
// exe_reader1.addIncludePath(.{ .path = override_include_dir });
// exe_reader1.addIncludePath(.{ .path = win32_include_dir });
// exe_reader1.linkLibrary(libxml2);
// b.installArtifact(exe_reader1);
//
// const run_tests = b.addRunArtifact(exe_reader1);
